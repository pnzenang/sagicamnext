...
export type FeesCopy = PricingPlansSectionCopy & {
  plans: PricingPlan[]
}

export const defaultFeesCopy: FeesCopy = {
...
const Payout = ({ copy = defaultFeesCopy }: { copy?: FeesCopy }) => {
  return (
